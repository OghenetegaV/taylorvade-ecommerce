...
const SearchIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#3a2e22" strokeWidth="1.3" strokeLinecap="round">
    <circle cx="11" cy="11" r="7"/><line x1="16.5" y1="16.5" x2="22" y2="22"/>
  </svg>
);
const StarIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#3a2e22" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round">
...
const ChevronDown = () => (
  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#3a2e22" strokeWidth="1.5" strokeLinecap="round">
    <path d="M6 9l6 6 6-6"/>
  </svg>
);
const EiffelIcon = () => (
...
export default function Header() {
  ...
  return (
    <>
      {/* ── Header bar ── */}
      <header className="absolute top-[10px] left-0 w-full z-50">
        <div className="relative flex items-center justify-between px-5 md:px-9 py-6">
          ...
          <Link href="/" className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
            <div className="relative w-[200px] md:w-[360px] h-[32px] md:h-[48px]">
          ...
          <div className="flex items-center gap-[13px] md:gap-[16px]">
            ...
            <button aria-label="Wishlist"><StarIcon /></button>
            <button aria-label="Account"><UserIcon /></button>
            <button aria-label="Bag"><BagIcon /></button>
            {/* Nigeria flag — fills circular frame */}
            <button
              aria-label="Region"
      ...
      <div className={`fixed top-0 left-0 h-full w-[290px] max-w-[80vw] z-[100] flex flex-col
        ...
        <div className="flex items-center gap-2.5 px-5 pt-5 pb-4">
          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#3a2e22" strokeWidth="1.4" strokeLinecap="round">
            <circle cx="11" cy="11" r="7"/><line x1="16.5" y1="16.5" x2="22" y2="22"/>
          </svg>
          <input
            type="text"
      ...
      <div className="fixed inset-0 z-[120] flex items-center justify-center pointer-events-none">
        ...
        >
          ...
          {/* Ship To */}
          <p className="text-center text-[11px] tracking-[0.12em] text-[#3a2e22] mb-2 font-serif">
            Ship To:
          </p>
          ...
          <div className="relative mb-6">
            ...
            >
              ...
              <optgroup label="All Currencies">
                {ALL_CURRENCIES.filter(c => !SUGGESTED_CURRENCIES.includes(c)).map(c => (
                  <option key={c} value={c}>{c}</option>
                ))}
              </optgroup>
            </select>
