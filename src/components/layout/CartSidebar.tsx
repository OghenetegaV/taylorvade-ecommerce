...
export default function CartSidebar({ open, onClose, onCountChange }: Props) {
  ...
  return (
    <>
      ...
      <div className={`fixed top-0 right-0 h-full w-[320px] max-w-[90vw] z-[100] flex flex-col
        ...
        {/* Header */}
        <div className="flex items-center justify-between px-6 pt-6 pb-4 border-b border-[#d5cec4]">
          <p className="text-[11px] tracking-[0.2em] text-[#3a2e22] uppercase font-serif">
