  ...
  return (
    <div className="min-h-screen bg-[#fafafa] flex items-center justify-center px-6 font-serif">
      <div className="text-center max-w-md">
        <p className="text-[11.5px] tracking-[0.3em] uppercase text-[#8f8f8a] mb-4">Order Confirmed</p>
        ...
        {orderId && (
          <p className="text-[12.5px] tracking-[0.12em] text-[#8f8f8a] mb-8">
        ...
        <div className="flex items-center justify-center gap-5">
          ...
          <Link href="/collections/woman"
            className="text-[12.5px] tracking-[0.15em] uppercase text-[#111] underline underline-offset-4 hover:opacity-60 transition-opacity">
            Keep Shopping
          </Link>
        </div>
      </div>
