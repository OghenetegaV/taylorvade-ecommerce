                ...
                <table className="w-full text-[12px] border-collapse mt-2">
                  <thead>
                    <tr className="border-b border-[#e8e2db]">
                      <th className="text-left py-2 pr-3 text-[#8a7a6a] uppercase tracking-[0.06em] text-[10.5px]">Name</th>
                      <th className="text-left py-2 pr-3 text-[#8a7a6a] uppercase tracking-[0.06em] text-[10.5px]">Purpose</th>
                      <th className="text-left py-2 text-[#8a7a6a] uppercase tracking-[0.06em] text-[10.5px]">Duration</th>
                    </tr>
                  </thead>
                  <tbody>
                    {COOKIES.map(c => (
                      <tr key={c.name} className="border-b border-[#e8e2db]">
                        <td className="py-2.5 pr-3 text-[#3a2e22] font-mono text-[11px]">{c.name}</td>
            ...
            <Section id="storage" title="Local Storage">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-[12px] border-collapse mt-2">
                  <thead>
                    <tr className="border-b border-[#e8e2db]">
                      <th className="text-left py-2 pr-3 text-[#8a7a6a] uppercase tracking-[0.06em] text-[10.5px]">Key</th>
                      <th className="text-left py-2 text-[#8a7a6a] uppercase tracking-[0.06em] text-[10.5px]">Purpose</th>
                    </tr>
                  </thead>
                  <tbody>
                    {LOCAL_STORAGE.map(c => (
            ...
            <div className="mt-16 pt-8 border-t border-[#e8e2db]">
              <div className="flex flex-wrap items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-6">
                  <Link href="/privacy" className="text-[10px] tracking-[0.1em] text-[#9a8a7a] hover:text-[#3a2e22] transition-colors">
                    Privacy Policy
                  </Link>
