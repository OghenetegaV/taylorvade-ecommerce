    ...
    <div className="min-h-screen bg-[#f7f5f2] flex items-center justify-center px-4 font-serif">
      <div className="w-full max-w-[380px]">
        <div className="text-center mb-10">
          ...
          <p className="text-[11.5px] tracking-[0.3em] text-[#8a7a6a] uppercase mt-2">Reset Password</p>
        </div>
        <div className="bg-white border border-[#e8e2db] p-8">
          {sent ? (
            <div className="text-center">
              ...
              <p className="text-[14.5px] text-[#1a1008] mb-2">Email sent</p>
              <p className="text-[13px] text-[#8a7a6a] leading-relaxed">
                A reset link has been sent to <strong className="text-[#1a1008]">{email}</strong>.
              </p>
              <Link href="/login" className="inline-block mt-6 text-[12.5px] text-[#8a7a6a] hover:text-[#1a1008] underline underline-offset-2 transition-colors">Back to Sign In</Link>
            </div>
          ) : (
            <>
              <p className="text-[13.5px] text-[#8a7a6a] leading-relaxed tracking-wide mb-5">
