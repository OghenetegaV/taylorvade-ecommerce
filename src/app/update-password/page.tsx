    ...
    <div className="min-h-screen bg-[#f7f5f2] flex items-center justify-center px-4 font-serif">
      <div className="w-full max-w-[380px]">
        <div className="text-center mb-10">
          ...
          <p className="text-[10px] tracking-[0.3em] text-[#8a7a6a] uppercase mt-2">Set New Password</p>
        </div>
        <div className="bg-white border border-[#e8e2db] p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-[10px] tracking-[0.2em] text-[#8a7a6a] uppercase mb-1.5">New Password</label>
